    ...
    async loadTemplatesFromDB() {
        try {
            ...
            for (const template of templates) {
                ...
                template.elements_config = JSON.parse(template.elements_config || '{}');
                template.footer_content = JSON.parse(template.footer_content || '{}');
    ...
    async reloadTemplateById(id) {
        ...
        try {
            ...
            if (template) {
                ...
                console.log('🔄 DEBUG - Template rechargé avec footer_content:', template.footer_content);
